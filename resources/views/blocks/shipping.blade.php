...
<section data-gsap-anim="section" @if($id) id="{{ $id }}" @endif class="shipping {{ $sectionClass }} {{ $class }}">
	<div class="">

		@if (!empty($g_shipping['title']))
		<h2 class="">{{ strip_tags($g_shipping['title']) }}</h2>
		@endif


		<div class="grid gap-4 mt-4">
			@foreach ($g_shipping['r_shipping'] as $item)
